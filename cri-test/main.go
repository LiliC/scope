...
func main() {
	...
	listContainersResponse, err := criConn.ListContainers(ctx, &cri.ListContainersRequest{})
	if err != nil {
		fmt.Println(err)
		os.Exit(1)
	}
	fmt.Printf("%#+v", listContainersResponse.Containers)
